...
The prototype models a synthetic navigation environment with Wi-Fi communication clusters. The UAV must move from point `A` to point `B` while periodically reconnecting to communication zones and never exceeding the allowed offline time.
